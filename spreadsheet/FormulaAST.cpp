...
namespace ASTImpl
{
    ...
    public:
        ...
        virtual double Evaluate(CellTranclatorLambda args) const = 0;
    ...
    namespace
    {
        ...
        public:
            ...
            double Evaluate([[maybe_unused]] CellTranclatorLambda args) const override
            {
                switch (type_)
                {
                case Add:
        ...
        public:
            ...
            double Evaluate([[maybe_unused]] CellTranclatorLambda args) const override
            {
                if (type_ == UnaryMinus)
                {
                    return (-1 * operand_.get()->Evaluate(args));
                }
        ...
        public:
            ...
            double Evaluate(CellTranclatorLambda args) const override
            {
                    return args(cell_);
            }
...
double FormulaAST::Execute(CellTranclatorLambda args) const
{
